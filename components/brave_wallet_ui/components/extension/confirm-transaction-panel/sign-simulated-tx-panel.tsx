...
// Styled Components
import { Column, ErrorText, FullWidth, Text } from '../../shared/style'
import {
  LearnMoreButton,
  TabRow,
  WarningBox,
...
type Props = {
  ...
  onAcceptSigningRisks: () => void | Promise<void>
  onCancelSign: () => void | Promise<void>
...
/**
 * @returns For Solana transaction signature requests
 */
                ...
                {txSimulation.warnings.length > 1 ? (
                  ...
                  <>
                    <Alert
                      mode='simple'
                      type={
                        (txSimulation.warnings[0]
                          .severity as BlowfishWarningSeverity) === 'CRITICAL'
                          ? 'error'
                          : 'warning'
                      }
                    >
